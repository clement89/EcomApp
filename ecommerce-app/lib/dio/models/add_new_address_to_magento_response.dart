...
//
//     final addNewAddressToMagentoResponse = addNewAddressToMagentoResponseFromJson(jsonString);

import 'dart:convert';

AddNewAddressToMagentoResponse addNewAddressToMagentoResponseFromJson(String str) => AddNewAddressToMagentoResponse.fromJson(json.decode(str));

String addNewAddressToMagentoResponseToJson(AddNewAddressToMagentoResponse data) => json.encode(data.toJson());

class AddNewAddressToMagentoResponse {
  AddNewAddressToMagentoResponse({
    this.id,
    this.groupId,
    this.createdAt,
    this.updatedAt,
  ...
  factory AddNewAddressToMagentoResponse.fromJson(Map<String, dynamic> json) => AddNewAddressToMagentoResponse(
