...
SampleResponse loginResponseFromJson(String str) => SampleResponse.fromJson(json.decode(str));

String loginResponseToJson(SampleResponse data) => json.encode(data.toJson());
